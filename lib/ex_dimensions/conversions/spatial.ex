defmodule ExDimensions.Conversions.Spatial do
  ...
  def mappings(),
    do: [
      ...
      # a module attribute
      {[ExDimensions.Spatial.Inches], [&Kernel.//2, 12], [&Kernel.*/2, 12],
       [ExDimensions.Spatial.Feet]},
      {[ExDimensions.Spatial.Feet], [&Kernel.//2, 3], [&Kernel.*/2, 3],
       [ExDimensions.Spatial.Yards]},
      {[ExDimensions.Spatial.Feet], [&Kernel.//2, 5280], [&Kernel.*/2, 5280],
